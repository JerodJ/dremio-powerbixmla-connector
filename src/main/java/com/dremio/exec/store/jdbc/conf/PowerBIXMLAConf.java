...
@SourceType(value = "PowerBIXMLAARP", label = "PowerBIXMLA",uiConfig = "powerbixmla-layout.json")
public class PowerBIXMLAConf extends AbstractArpConf<PowerBIXMLAConf> {
  private static final String ARP_FILENAME = "arp/implementation/powerbixmla-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.powerbixmla.PowerBIXMLADriver";
